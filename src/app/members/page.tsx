...
const members = [
    ...
    { name: "Government of Haryana", href: "https://haryana.gov.in/", logoUrl: "https://i.postimg.cc/j2qYy3HN/haryana-govt11.png", hint: "government logo", className: "p-2 bg-white rounded-md", isSpecial: true },
