...
const leadership = [
  ...
  { name: "Mr. Surajit Kalita", title: "Vice-Chairman(Operation & Planning), IJCC", imageUrl: "https://i.postimg.cc/mZyH5rcb/surajit.jpg", hint: "man face", bio: "Mr. Surajit Kalita is a master of logistics and planning. His role as Vice-Chairman of Operations & Planning ensures the smooth execution of all IJCC events, delegations, and initiatives, making every interaction seamless and effective." },
...
const advisors = [
  ...
  { name: "Mr. Naveen Verma", title: "Chairman, RERA Bihar", imageUrl: "https://i.postimg.cc/CK70VjSM/Naveen-Verma-2.jpg", hint: "man face", bio: "Mr. Naveen Verma brings his regulatory expertise as the Chairman of RERA Bihar to the chamber. His insights are crucial for navigating the complexities of the real estate and infrastructure sectors for Japanese investors in India." },
  { name: "Mr. Anil Kumar Khandelwal", title: "Ex. General Manager, East Central Railway", imageUrl: "https://i.postimg.cc/wvCrmvkR/anil.jpg", hint: "man face", bio: "With a long and distinguished career in the Indian Railways, Mr. Anil Kumar Khandelwal provides strategic advice on infrastructure and transportation projects. His experience is vital for large-scale collaborations between India and Japan." },
  { name: "Dr. Randeep Rakwal", title: "Professor, Tsukuba University, Japan", imageUrl: "https://i.postimg.cc/bJ2RnfLZ/randeep.jpg", hint: "man face", bio: "Dr. Randeep Rakwal is a distinguished academic and researcher at Tsukuba University. His work in biotechnology has led to significant advancements and collaborative projects between Indian and Japanese research institutions, fostering a new generation of scientists." },
...
const foundingMembers = [
  ...
  { name: "Mr. M Nazir", title: "Founding Member, Director ICAE India", imageUrl: "https://i.postimg.cc/TY0ZknqT/nazir.jpg", hint: "man face", bio: "Mr. M Nazir, another founding member, has been a pillar of the IJCC. As Director of ICAE India, he has championed numerous initiatives focused on adult education and vocational training, aligning Indian talent with Japanese industry needs." },
