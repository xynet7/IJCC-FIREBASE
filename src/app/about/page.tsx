...
const leadership = [
  { name: "Mr. Rahul Mishra", title: "Chairman, IJCC", imageUrl: "https://www.ijcc.in/images/WhatsApp%20Image%202025-08-08%20at%2012.04.51.jpeg", hint: "man face", bio: "Rahul Mishra is the Vice President of SEWA Foundation and Managing Director of Aamida Infotech, with over 18 years of experience in international business development, operations, and consulting. Since founding Aamida Consulting Services (ACS) in 2011, he has successfully expanded its presence across India, driving strategic growth and long-term client partnerships.\n\nBefore his entrepreneurial journey, he worked with leading IT organizations including Oracle, IBM, SAP Labs, McAfee, MothersonSumi Infotech, Four Soft, and Nucleus Software, gaining deep expertise in technology and operations.\n\nRahul holds an MBA in International Marketing from ICFAI, Hyderabad, and is passionate about the education sector, manufacturing industry, and information technologies. He is also associated with the Japan Foundation, contributing to cross-cultural and business collaborations. Guided by his belief in building authentic, meaningful, and lasting relationships, Rahul continues to play a key role in fostering innovation and international cooperation." },
