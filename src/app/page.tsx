...
const partners = [
    ...
    { name: "Government of Haryana", href: "https://haryana.gov.in/", logoUrl: "https://images.seeklogo.com/logo-png/44/2/haryana-sarkar-logo-png_seeklogo-447946.png", hint: "government logo" },
];
